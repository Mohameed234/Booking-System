...
<div class="max-w-3xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
    ...
    <!-- Form -->
    <form method="POST" action="{{ route('flights.update', $flight->id) }}" class="p-6 space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="origin" value="{{ old('origin', $flight->origin) }}"
                    class="w-full rounded-lg border-2 border-gray-300 px-3 py-2 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-gray-900 font-medium">
            ...
            <div>
                ...
                <input type="text" name="destination" value="{{ old('destination', $flight->destination) }}"
                    class="w-full rounded-lg border-2 border-gray-300 px-3 py-2 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-gray-900 font-medium">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="number" name="seats_available" value="{{ old('seats_available', $flight->seats_available) }}"
                    class="w-full rounded-lg border-2 border-gray-300 px-3 py-2 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-gray-900 font-medium">
            ...
            <div>
                ...
                <input type="number" step="0.01" name="price" value="{{ old('price', $flight->price) }}"
                    class="w-full rounded-lg border-2 border-gray-300 px-3 py-2 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 text-gray-900 font-medium">
